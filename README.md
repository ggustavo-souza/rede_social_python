...
A ideia é além de trabalhar conhecimentos de backend (API REST, autenticação JWT, processamento de imagens) também fazer do projeto uma aplicação visualmente agradável. <br>
...
O client, que será a aplicação web feita em React, fará requisições para o server, que é feito em Python (FastAPI), que por sequência irá interagir com o banco de dados SQLite presente em forma de arquivo no servidor.

### Linguagens e Bibliotecas
A seguir, estão listadas as bibliotecas/Frameworks utilizada(o)s no desenvolvimento tanto do Frontend quando do Backend
